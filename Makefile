...
GOBUILD=CGO_ENABLED=0 go build -ldflags '-X "github.com/blueicesir/clash/constant.Version=$(VERSION)" \
		-X "github.com/blueicesir/clash/constant.BuildTime=$(BUILDTIME)" \
		-w -s'
